  ...
  return (
    <section className="py-24 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4">
        <motion.div
          {...fadeUp()}
          className="bg-gradient-to-r from-blue-600 to-cyan-400 rounded-2xl shadow-xl p-10 md:p-12 text-white text-center"
        >
          <h2 className="text-3xl md:text-4xl font-bold mb-4">
            Siap Memulai Website untuk Bisnis Anda?
          </h2>
          <p className="text-lg md:text-xl opacity-90 mb-8 max-w-2xl mx-auto">
            Konsultasikan kebutuhan website Anda bersama kami. Kami siap membantu dari tahap perencanaan hingga website siap digunakan.
          </p>
          <a
