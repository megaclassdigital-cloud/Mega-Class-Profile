...
const titleCards = [
  {
    ...
    accent: "#ffd84d",
    icon: TrophyIcon,
    image: "/images/meca/mecademy-mvs-character-v1.webp",
    span: "lg:col-span-5",
    tilt: "-1.8deg",
  },
  {
    ...
    accent: "#ff4fd8",
    icon: SparklesIcon,
    image: "/images/meca/mecademy-king-queen-character-v1.webp",
    span: "lg:col-span-7",
    tilt: "1.3deg",
  },
  {
    ...
    accent: "#18d5ff",
    icon: CheckBadgeIcon,
    image: "/images/meca/mecademy-forgotten-one-character-v1.webp",
    span: "lg:col-span-7",
    tilt: "-1.1deg",
  },
  {
    ...
    accent: "#b8ff5b",
    icon: BoltIcon,
    image: "/images/meca/mecademy-rich-guy-character-v1.webp",
    span: "lg:col-span-5",
    tilt: "1.9deg",
  },
] as const;
